...
public class CategoryController {
	...
	public CategoryController (CategoryService categoryService, FileUtil fileU) {
	...
	public String upload(@PathVariable long id, @RequestParam("file") MultipartFile file) throws IOException {
		...
		filename = fileU.save(destFolder, filename, file.getBytes());
	...
	public byte[] getCover(@PathVariable String filename) throws IOException {
		Resource resource = fileU.load(destFolder, filename);
