...
<div class="container">
    ...
    <div class="row pb-4">
        <div class="col-3"><span class="fw-bold">Price</span></div>
        <div class="col-9">&euro;${product.getPrice()}</div>
    </div>

    <div class="row pb-4">
        <div class="col-3"><span class="fw-bold">Discount</span></div>
        <div class="col-9">${product.getDiscountPercent()}</div>
    </div>

    <div class="row pb-4">
        <div class="col-3"><span class="fw-bold">Stock Quantity %</span></div>
        <div class="col-9">${product.getStockQuantity()}</div>
    </div>

    <div class="row pb-4">
        <div class="col-3"><span class="fw-bold">Categories</span></div>
        <div class="col-9">
